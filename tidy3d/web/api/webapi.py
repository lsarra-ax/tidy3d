...
from ..core.constants import SIM_FILE_HDF5, TaskId, SIM_FILE_HDF5_GZ, MODE_FILE_HDF5_GZ, SIMULATION_DATA_HDF5_GZ, MODE_DATA_HDF5_GZ
...
def download(
    ...
    task = SimulationTask(taskId=task_id)
    task.get_sim_data_hdf5(path, verbose=verbose, progress_callback=progress_callback, remote_data_file=remote_data_file)
...
def download_hdf5(
    ...
    task = SimulationTask(taskId=task_id)
    task.get_simulation_hdf5(path, verbose=verbose, progress_callback=progress_callback, remote_sim_file=remote_sim_file)
