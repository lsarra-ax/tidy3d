...
SimulationType = Union[Simulation, HeatSimulation, EMESimulation, ModeSolver]
SimulationDataType = Union[SimulationData, HeatSimulationData, EMESimulationData, ModeSolverData]
...
class Tidy3dStubData(BaseModel, TaskStubData):
    ...
    def postprocess(cls, file_path: str) -> SimulationDataType:
        ...
        if not isinstance(stub_data, ModeSolverData) and "WARNING" in stub_data.log and not warned_about_warnings:
